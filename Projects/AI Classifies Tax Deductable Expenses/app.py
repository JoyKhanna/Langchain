...
# ============================================================
# File paths
DATA_DIR = "F:\GenAILangchain\Projects\AI Classifies Tax Deductable Expenses\data"
INPUT_EXCEL_PATH = os.path.join(DATA_DIR, "test_input.csv")
OUTPUT_CSV_PATH = os.path.join(DATA_DIR, "categorized_expenses.csv")
PROMPT_FILE_PATH = "F:\GenAILangchain\Projects\AI Classifies Tax Deductable Expenses\prompt.yaml"
...
# ============================================================
def initialize_llm(ChatOllama) :                                    # why ChatOllama parameter ???????????????????????????????????????????????????????
